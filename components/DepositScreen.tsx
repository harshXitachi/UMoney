...
const DepositScreen: React.FC = () => {
  ...
  // Constants
  const TRC20_ADDRESS = "TVjsyZ7sWvJgM8p4G8MockTRC20Address7788";
  ...
  const calculatedInr = (usdtValue * 99.0).toFixed(2);
            ...
            {depositStep === 'INPUT' ? (
                ...
                <>
                    ...
                    <div className="w-auto flex-none bg-[#eef2ff] rounded-lg flex items-center justify-center py-3 px-3">
                        <span className="text-xs font-bold text-[#2546a3] whitespace-nowrap">1 USDT = 99.0 INR</span>
                    </div>
                    </div>
                ...
                <div className="animate-fade-in">
                    ...
                    <div className="bg-[#eef2ff] rounded-lg p-4 mb-6 flex flex-col items-center">
                        ...
                        <div className="bg-white p-2 rounded-lg shadow-sm mb-4">
                            ...
                            <img 
                                src={`https://api.qrserver.com/v1/create-qr-code/?size=160x160&data=${TRC20_ADDRESS}`} 
                                alt="USDT QR Code" 
                                className="w-40 h-40"
                            />
                        </div>
